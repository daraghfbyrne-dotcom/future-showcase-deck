...
import { TrendingUp, Target, CheckCircle2, RotateCcw, Save } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
...
const pipelineData: StageData[] = [
  ...
  },
  {
    ...
    indexTarget: "13.9",
    actions: [
      { id: "3-4-s1", text: "Share recording & deck same day (Allego - Digital Sales Room)", category: "sales" },
      { id: "3-4-s2", text: "Drive timeline - schedule follow up on the call", category: "sales" },
      { id: "3-4-s3", text: "Identify key stakeholders", category: "sales" },
      { id: "3-4-s4", text: "Personal invite to upcoming events (webinar, dinner, conference)", category: "sales" },
      { id: "3-4-m1", text: "RFP Template", category: "marketing" },
      { id: "3-4-m2", text: "Landing pages", category: "marketing" },
      { id: "3-4-m3", text: "Change Events (Scale/growth, Cost, Fraud, AI, Einvoicing, ERP)", category: "marketing" },
      { id: "3-4-m4", text: "Relevant Case Studies by ERP", category: "marketing" },
      { id: "3-4-m5", text: "ROI Calculator", category: "marketing" },
      { id: "3-4-m6", text: "Art of the possible opportunity campaign", category: "marketing" },
    ],
  },
  {
    id: "4-5",
...
export const PipelineConversion = () => {
  ...
  return (
    <section id="pipeline-conversion" className="py-20 bg-muted/30">
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h2 className="font-display font-bold text-4xl md:text-5xl">
                Pipeline <span className="text-primary">Conversion</span>
              </h2>
            </div>
            <p className="text-muted-foreground">
              Track and improve conversion rates across pipeline stages
            </p>
          ...
          <Card>
            ...
            <CardContent>
              <Accordion type="multiple" defaultValue={["3-4", "4-5", "5-6"]} className="space-y-4">
                {pipelineData
