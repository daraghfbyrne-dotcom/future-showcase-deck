...
export const ResearchProgram = () => {
  return (
    <section id="research" className="py-24 bg-gradient-to-b from-primary/5 via-accent/5 to-secondary/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          {/* ============================================ */}
          {/* 2026/27 RESEARCH PROGRAM SECTION */}
          {/* ============================================ */}
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-primary/20 to-accent/20 border-2 border-primary/30 mb-8 shadow-lg">
              ...
              <span className="text-xl font-bold text-primary tracking-wide">2026/27</span>
              <Zap className="w-6 h-6 text-accent" />
            </div>
            <h2 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl mb-6">
              Research <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">Program</span>
            </h2>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
